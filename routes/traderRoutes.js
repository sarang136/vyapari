...
const { postGrade, registerTrader, loginTrader, getGradesByTraderId, getGrates, deleteGrade, updateGradebyId, addProduct, logout } = require('../controllers/traderController');
